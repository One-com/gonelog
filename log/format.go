...
func (f *minformatter) Clone(allow_upgrade bool) (new CloneableHandler) {
	if allow_upgrade {
		new = &flxformatter{out: f.out, flag: Llevel, pool: f.pool}
	} else {
...
func (f *flxformatter) Clone(au bool) CloneableHandler {
	new := &flxformatter{}
...
/*---------------- A formatter only aiming at compatibility -------------------*/
...
// Clone
func (f *stdformatter) Clone(allow_upgrade bool) (new CloneableHandler) {
